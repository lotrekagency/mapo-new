    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: 'Media Manager', link: '/howto/media-manager' },
          { text: 'Menu Manager', link: '/howto/menu-manager' },
          { text: 'Translating the UI', link: '/howto/i18n' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Media Manager', link: '/uikit/media' },
          { text: 'Menu Manager', link: '/uikit/menu-manager' },
